...
st.markdown(
    ...
    <div style="background: linear-gradient(90deg, #1e293b, #0f172a); border: 1px solid #00FFA3; border-radius: 12px; padding: 1rem 1.5rem; margin-bottom: 1rem; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="display: flex; gap: 0.5rem;">
            ...
            <a href="https://unified-ops-ax-652787573242.us-central1.run.app/ops/preflight" target="_blank" style="background: #2563eb; color: #ffffff; text-decoration: none; padding: 0.5rem 1rem; border-radius: 8px; font-weight: 600; font-size: 0.85rem;">
                ⚡ Cloud Run Preflight
            </a>
        </div>
    </div>
